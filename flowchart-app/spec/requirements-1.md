...
A client-side React web application that lets users build flowchart diagrams through a drag-and-drop interface. Users drag standard flowchart shapes onto a canvas, connect them with arrows, edit labels, resize shapes, and export the result as valid Mermaid flowchart syntax. Initial version supports flowcharts only.
...
- [x] All 5 user stories map to the core idea in `idea.md`
